...
public class RSSFeedParserHinduNews {
	...
	public RSSFeedParserHinduNews(String filename) {
		...
		try {
			...
			while (eventReader.hasNext()) {
				...
				if (event.isStartElement()) {
					...
					System.out.println("mainlocalpart" + mainlocalPart);
					...
					case ITEM:
						if (isFeedHeader) {
							...
							System.out.println("feed data" + title + link + pubdate);
						}
					...
					case TITLE:
						...
						System.out.println("title++++++++1234" + title);
						break;
					case DESCRIPTION:
					...
					case AUTHOR:
						...
						author = eventReader.getElementText();
						break;
					case PUB_DATE:
						// pubdate = getCharacterData(event, eventReader);
						pubdate = eventReader.getElementText();
						break;
					case COPYRIGHT:
